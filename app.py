...
_SCENES = {
    ...
    3: _wrap(_sky("b", "#43b6de", "#bfe6f2")
             ...
             + "<defs><linearGradient id='sea' x1='0' y1='0' x2='0' y2='1'>"
               "<stop offset='0' stop-color='#5fbcda'/><stop offset='1' stop-color='#1c86ac'/></linearGradient></defs>"
             ...
             + "<path d='M1002,330 L1010,250 Q1055,232 1110,244 L1200,238 L1200,330 Z' fill='#6f8768'/>"
             + "<path d='M1002,330 L1010,286 Q1090,272 1200,284 L1200,330 Z' fill='#5c7358' opacity='0.6'/>"
             + "<rect x='1030' y='262' width='26' height='30' fill='#d9885a'/><rect x='1030' y='262' width='26' height='4' fill='#b3502f'/><rect x='1036' y='274' width='4' height='6' fill='#3a4a5a'/><rect x='1046' y='274' width='4' height='6' fill='#3a4a5a'/><rect x='1062' y='270' width='24' height='28' fill='#e6c98a'/><rect x='1062' y='270' width='24' height='4' fill='#b3502f'/><rect x='1067' y='281' width='4' height='6' fill='#3a4a5a'/><rect x='1077' y='281' width='4' height='6' fill='#3a4a5a'/><rect x='1092' y='260' width='26' height='32' fill='#cf7a68'/><rect x='1092' y='260' width='26' height='4' fill='#b3502f'/><rect x='1098' y='273' width='4' height='6' fill='#3a4a5a'/><rect x='1108' y='273' width='4' height='6' fill='#3a4a5a'/><rect x='1120' y='272' width='24' height='26' fill='#d9a95f'/><rect x='1120' y='272' width='24' height='4' fill='#b3502f'/><rect x='1125' y='282' width='4' height='6' fill='#3a4a5a'/><rect x='1135' y='282' width='4' height='6' fill='#3a4a5a'/><rect x='1050' y='244' width='24' height='26' fill='#e0d3a0'/><rect x='1050' y='244' width='24' height='4' fill='#b3502f'/><rect x='1055' y='254' width='4' height='6' fill='#3a4a5a'/><rect x='1065' y='254' width='4' height='6' fill='#3a4a5a'/><rect x='1082' y='242' width='22' height='24' fill='#d98a6a'/><rect x='1082' y='242' width='22' height='4' fill='#b3502f'/><rect x='1087' y='252' width='4' height='6' fill='#3a4a5a'/><rect x='1096' y='252' width='4' height='6' fill='#3a4a5a'/><rect x='1112' y='248' width='24' height='28' fill='#e6c98a'/><rect x='1112' y='248' width='24' height='4' fill='#b3502f'/><rect x='1117' y='259' width='4' height='6' fill='#3a4a5a'/><rect x='1127' y='259' width='4' height='6' fill='#3a4a5a'/><rect x='1146' y='266' width='22' height='30' fill='#cf8a5a'/><rect x='1146' y='266' width='22' height='4' fill='#b3502f'/><rect x='1151' y='278' width='4' height='6' fill='#3a4a5a'/><rect x='1160' y='278' width='4' height='6' fill='#3a4a5a'/><rect x='1150' y='244' width='20' height='24' fill='#dcb877'/><rect x='1150' y='244' width='20' height='4' fill='#b3502f'/><rect x='1154' y='254' width='4' height='6' fill='#3a4a5a'/><rect x='1162' y='254' width='4' height='6' fill='#3a4a5a'/>"
             ...
             + "<path d='M0,400 L0,320 Q300,306 600,324 T1200,318 L1200,400 Z' fill='#f0d68f'/>"
             + "<path d='M0,320 Q300,306 600,324 T1200,318' fill='none' stroke='#ffffff' stroke-width='4' opacity='0.7'/>"
             + "<path d='M0,340 Q300,328 600,344 T1200,338' fill='none' stroke='#e6c07a' stroke-width='6' opacity='0.5'/>"
             + "<path d='M148,344 Q150,278 160,208' fill='none' stroke='#8a6a44' stroke-width='9' stroke-linecap='round'/>"
             + "<g fill='#2e7d4f'><path d='M160,208 Q104,196 66,216 Q110,206 160,222 Z'/>"
               "<path d='M160,208 Q216,194 254,214 Q210,206 160,222 Z'/>"
               "<path d='M160,208 Q120,180 96,150 Q142,182 164,214 Z'/>"
               "<path d='M160,208 Q200,180 226,152 Q178,182 160,214 Z'/></g>"
             + "<g fill='#3f9d63'><path d='M160,208 Q110,206 82,232 Q124,214 162,222 Z'/>"
               "<path d='M160,208 Q210,206 240,232 Q196,214 160,222 Z'/></g>"
             + "<circle cx='160' cy='208' r='7' fill='#8a6a44'/>"
             + "<path d='M470,352 Q472,318 480,286' fill='none' stroke='#8a6a44' stroke-width='6' stroke-linecap='round'/>"
             + "<g fill='#2e7d4f'><path d='M480,286 Q446,278 424,292 Q452,282 482,296 Z'/>"
               "<path d='M480,286 Q514,278 536,292 Q508,282 480,296 Z'/>"
               "<path d='M480,286 Q456,266 442,246 Q470,268 484,290 Z'/>"
               "<path d='M480,286 Q504,266 518,246 Q490,268 480,290 Z'/></g>"
             + "<rect x='832' y='330' width='3' height='40' fill='#7a5a3a'/>"
             + "<path d='M800,332 Q834,304 868,332 Z' fill='#e04a3a'/>"
             + "<path d='M817,318 L834,332 L800,332 Z' fill='#f7f2ec'/><path d='M851,318 L868,332 L834,332 Z' fill='#f7f2ec'/>"
             + "<circle cx='834' cy='304' r='3' fill='#c53a2c'/>"),
