...
_SCENES = {
    ...
    2: _wrap(_sky("r", "#6aa6d6", "#d0e3ef")
             ...
             + "<path d='M0,212 L90,150 L150,180 L250,118 L330,165 L430,106 L520,158 L620,116 L730,156 "
               "L840,108 L950,162 L1060,128 L1160,166 L1200,148 L1200,235 L0,235 Z' fill='#a9c2d8' opacity='0.6'/>"
             + "<g fill='#eef4fa' opacity='0.85'><path d='M250,118 L236,146 L264,146 Z'/><path d='M430,106 L415,138 L445,138 Z'/>"
               "<path d='M620,116 L606,144 L634,144 Z'/><path d='M840,108 L825,140 L855,140 Z'/>"
               "<path d='M1060,128 L1047,152 L1073,152 Z'/></g>"
             + "<path d='M0,236 L120,180 L240,214 L380,166 L520,206 L660,160 L810,206 L950,168 L1090,208 "
               "L1200,184 L1200,256 L0,256 Z' fill='#7d9bb0'/>"
             + "<g fill='#96b0c3' opacity='0.85'><path d='M120,180 L240,214 L180,214 Z'/><path d='M380,166 L520,206 L450,206 Z'/>"
               "<path d='M660,160 L810,206 L735,206 Z'/><path d='M950,168 L1090,208 L1020,208 Z'/></g>"
             + "<g fill='#e6eef6' opacity='0.7'><path d='M660,160 L649,182 L671,182 Z'/><path d='M120,180 L110,198 L130,198 Z'/></g>"
             + "<path d='M0,256 L200,228 L420,252 L650,224 L880,254 L1100,230 L1200,248 L1200,300 L0,300 Z' fill='#557a5f'/>"
             + "<g fill='#49694f' opacity='0.5'><ellipse cx='300' cy='250' rx='60' ry='14'/><ellipse cx='740' cy='248' rx='70' ry='14'/>"
               "<ellipse cx='1000' cy='252' rx='55' ry='13'/></g>"
             + "<path d='M0,400 L0,296 Q300,288 600,302 Q900,288 1200,296 L1200,400 Z' fill='#5c9070'/>"
             + "<path d='M0,400 L0,336 Q300,326 600,346 Q900,326 1200,336 L1200,400 Z' fill='#4c815f' opacity='0.5'/>"
             + "<ellipse cx='150' cy='324' rx='118' ry='22' fill='#8fbdd8'/>"
             + "<ellipse cx='150' cy='320' rx='90' ry='7' fill='#d6ecf6' opacity='0.5'/>"
             + "<path d='M846,286 L1150,278 L1165,344 L858,352 Z' fill='#6f9760'/>"
             + "<g fill='none' stroke='#3f6e48' stroke-width='2.5' opacity='0.9'><path d='M854,298 L1158,290'/>"
               "<path d='M856,312 L1160,304'/><path d='M858,326 L1162,318'/><path d='M860,340 L1164,332'/></g>"
             + "<g fill='#2f5e3f'><path d='M806,304 C797,301 796,268 806,250 C816,268 815,301 806,304 Z'/>"
               "<path d='M832,308 C823,305 822,272 832,256 C842,272 841,305 832,308 Z'/>"
               "<path d='M858,310 C850,307 849,278 858,264 C867,278 866,307 858,310 Z'/></g>"
             ...
             + "<path d='M700,298 C684,330 640,352 600,372 C578,384 590,392 604,400 L820,400 "
               "C834,392 812,384 792,372 C744,352 730,330 728,298 Z' fill='url(#w2)'/>"
             + "<g fill='#eaf6fc' opacity='0.5'><ellipse cx='650' cy='384' rx='34' ry='2.5'/>"
               "<ellipse cx='720' cy='392' rx='44' ry='3'/><ellipse cx='690' cy='366' rx='24' ry='2'/></g>"
             + "<g fill='#8f8069'><rect x='668' y='340' width='14' height='40'/><rect x='703' y='340' width='14' height='42'/>"
               "<rect x='738' y='340' width='14' height='40'/></g>"
             + "<g fill='none' stroke='#95856c' stroke-width='5'><path d='M648,340 Q675,322 702,340'/>"
               "<path d='M700,340 Q717,320 734,340'/><path d='M732,340 Q759,322 774,340'/></g>"
             + "<rect x='642' y='326' width='138' height='12' rx='2' fill='#ab9b82'/>"
             + "<g fill='#c6b493'><rect x='646' y='319' width='5' height='8'/><rect x='688' y='319' width='5' height='8'/>"
               "<rect x='730' y='319' width='5' height='8'/><rect x='772' y='319' width='5' height='8'/></g>"
             ...
             + "<g fill='#2c3a24'><rect x='343' y='276' width='5' height='14'/><rect x='470' y='286' width='5' height='13'/>"
               "<rect x='1085' y='276' width='5' height='14'/><rect x='300' y='330' width='5' height='13'/></g>"
             + "<g fill='#3f7150'><circle cx='345' cy='262' r='19'/><circle cx='472' cy='274' r='16'/>"
               "<circle cx='1087' cy='262' r='19'/><circle cx='302' cy='318' r='15'/></g>"),
