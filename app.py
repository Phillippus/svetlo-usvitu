...
_SCENES = {
    ...
    2: _wrap(_sky("r", "#6aa6d6", "#d0e3ef")
             ...
             + "<path d='M0,236 L120,180 L240,214 L360,176 L470,204 L520,178 L560,208 L600,246 L640,208 L680,178 "
             ...
             + "<path d='M600,232 C596,246 594,252 591,258 C579,286 567,314 560,345 C558,375 556,390 556,400 "
               "L686,400 C686,388 664,375 662,345 C655,314 641,284 615,258 C611,252 609,246 606,232 "
               "C604,228 602,228 600,232 Z' fill='url(#w2)'/>"
