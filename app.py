...
_SCENES = {
    ...
    2: _wrap(_sky("r", "#6aa6d6", "#d0e3ef")
             ...
             + "<path d='M0,236 L120,180 L240,214 L380,166 L520,206 L605,226 L690,206 L810,204 L950,168 "
               "L1090,208 L1200,184 L1200,256 L0,256 Z' fill='#7d9bb0'/>"
             + "<g fill='#96b0c3' opacity='0.8'><path d='M120,180 L240,214 L180,214 Z'/><path d='M380,166 L520,206 L450,206 Z'/>"
               "<path d='M950,168 L1090,208 L1020,208 Z'/></g>"
             + "<path d='M0,256 L200,230 L420,254 L650,228 L880,256 L1100,232 L1200,250 L1200,300 L0,300 Z' fill='#557a5f'/>"
             ...
             + "<g fill='#2f5540'>" + "<polygon points='322,250 312,272 332,272'/><polygon points='347,236 336,263 358,263'/><polygon points='370,254 361,274 379,274'/><polygon points='394,236 383,261 405,261'/><polygon points='417,250 407,272 427,272'/><polygon points='440,236 429,263 451,263'/><polygon points='463,254 454,274 472,274'/><polygon points='487,242 477,267 497,267'/><polygon points='510,254 500,276 520,276'/><polygon points='533,242 523,267 543,267'/><polygon points='336,263 327,283 345,283'/><polygon points='380,265 370,287 390,287'/><polygon points='424,267 415,287 433,287'/><polygon points='468,265 458,287 478,287'/><polygon points='508,267 499,287 517,287'/>" + "</g>"
             ...
             + "<path d='M596,214 C578,250 556,292 560,336 C562,368 558,388 560,400 L760,400 "
               "C760,388 758,368 758,336 C758,300 690,252 616,214 Z' fill='url(#w2)'/>"
             + "<g fill='#eaf6fc' opacity='0.5'><ellipse cx='640' cy='384' rx='38' ry='2.5'/>"
               "<ellipse cx='670' cy='392' rx='46' ry='3'/><ellipse cx='648' cy='366' rx='26' ry='2'/>"
               "<ellipse cx='620' cy='300' rx='14' ry='1.6'/></g>"
             + "<g fill='#8f8069'><rect x='600' y='334' width='15' height='46'/><rect x='650' y='334' width='15' height='48'/>"
               "<rect x='700' y='334' width='15' height='46'/></g>"
             + "<g fill='none' stroke='#8a7b64' stroke-width='4'><path d='M578,335 Q599,349 620,335'/>"
               "<path d='M628,335 Q650,351 672,335'/><path d='M678,335 Q700,351 722,335'/>"
               "<path d='M728,335 Q745,349 760,335'/></g>"
             + "<rect x='572' y='322' width='196' height='13' rx='2' fill='#b0a086'/>"
             + "<g fill='#c6b493'><rect x='576' y='315' width='5' height='8'/><rect x='620' y='315' width='5' height='8'/>"
               "<rect x='664' y='315' width='5' height='8'/><rect x='708' y='315' width='5' height='8'/>"
               "<rect x='760' y='315' width='5' height='8'/></g>"
